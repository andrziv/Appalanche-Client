...
<template>
  <div class="relative flex flex-col h-full bg-white dark:bg-zinc-900">
    ...
    <div class="flex flex-col overflow-y-auto pb-4">
      ...
      <div class="flex-1">
        <div class="flex-1 p-4 border-b border-neutral-100 dark:border-zinc-800">
          <form id="modifyApplicationForm" @submit.prevent="save" class="space-y-2">
            <div class="flex flex-wrap items-center justify-between gap-2">
              <div class="flex flex-row items-center space-x-4">
                <div class="w-2/3 flex sm:space-x-4 rounded-full text-sm items-center font-semibold transition"
